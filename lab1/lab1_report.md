...
Скопировала промпт в LLM
Получила сгенерированный код
Вставила токен бота в переменную окружения
