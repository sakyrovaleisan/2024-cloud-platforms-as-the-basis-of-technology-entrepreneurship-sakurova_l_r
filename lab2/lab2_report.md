...
<img width="1394" height="669" alt="image" src="https://github.com/user-attachments/assets/13bab757-8c9b-4b6a-8bae-7332934288c9" />

В разделе настроек контейнера изменила параметр Container port с значения 8080 на 8090. После сохранения изменений и деплоя была автоматически создана новая ревизия сервиса Cloud Run. После применения изменений сервис продолжил корректно отвечать по тому же внешнему URL. 
<img width="1395" height="715" alt="image" src="https://github.com/user-attachments/assets/d59c2b5c-3456-4a57-872a-7f0455e4cf18" />

Я переключила 100% трафика на порт 8090 и подтвердила работоспособность.
<img width="1388" height="710" alt="image" src="https://github.com/user-attachments/assets/30291177-9bba-4085-9f7c-f98de6cc5a10" />
<img width="1028" height="683" alt="image" src="https://github.com/user-attachments/assets/62b722e2-1e2c-457f-af74-f6729edbaca3" />
